...
* 
* This file defines default values for variables and physical
* constants used throughout MCCE, and instantiates global
* variables. The library header also defines necessary data structures
* for geometry and force calculations. Finally, it instantiates the
* module functions for all steps of the MCCE program.
* -earosenz 07/03/2017
**********************************************************************/
 ...
 * File name defaults
 * 
 * Predefined file names for all of the data generated by MCCE runs.
 * Annotation of individual variables incomplete
 * -earosenz 07/03/2017
 *********************************************************************/
#define VERSION       "MCCE3.5"
#define USERERR -1
#define MAXCHAR_LINE 320
#define DUMMY_GDBM   "~temp.dbm.XXXXXX" //temporary run file; do not
					//repeat jobs in working
					//directories containing file

#define FN_RUNPRM    "run.prm"          //run parameter file

#define FN_HVROT     "hvrot.pdb"        //catalog of heavy atom
					//rotamers used in standard
					//Monte Carlo

#define STEP1_OUT    "step1_out.pdb"    
#define STEP2_OUT    "step2_out.pdb"
#define STEP3_OUT    "step3_out.pdb"
#define ENERGY_TABLE "energies.opp"     //zipped energies for all
					//conformers
...
/**********************************************************************
* The following constants define interconversion values at 298.15K
* 
* 1 kcal = 1.688 kT (Boltzmann constant * temperature)
* RT*log(1/[H+]) = 1.364 pH*kcal/mol
* 1 kJ = 0.239 kcal
*
* -earosenz, 07/03/2017
**********************************************************************/
...
/*********************************************************************
* This set of constants defines limiting values for some energy
* calculations
*
* -earosenz, 07/03/2017
**********************************************************************/
#define  MAXNBORS     10      //maximum electron energy state
#define  N_ELEM_MAX     60    //no elements past Nd supported
#define  VDW_CUTOFF_NEAR  1   //minimum distance for calculating vdW
#define  VDW_ELIMIT_NEAR  999 //maximum vdW clash force
#define  VDW_CUTOFF_FAR   10  //vdW calculation cutoff
#define  VDW_ELIMIT_FAR   0   //if vdW falls to 0 before 10 A, stop
			      //calculating it
//decorative
...
typedef struct {
        ...
        int *boundary1;/*1st boundary surrounding the core up to a
			 distance of 'b1_param' angstroms*/
  
        int *boundary2;/*2nd boundary (fixed) surrounding the 1st
			 boundary up to a distance of 'b2_param' +
			 'b1_param' angstrom*/
        int b1_count;
        int b2_count;
        int res_count;
